...
function Treatments() {
   ...
   // store all treatments in a hashmap with the key being the treatment and the values being the images, links, descriptions and list of concerns
    const treatmentsMap = {
        ...
        "DermalFillers": { title: "Dermal Fillers", image: DermalFillersIcon, link: "https://www.carismaaesthetics.com/dermalfillersmalta", description: "Dermal fillers are used to restore volume loss in the face. They are injected into the skin and are used to treat wrinkles, facial volume loss, thin lips, facial slimming and acne scars.", concerns: ["Wrinkles", "Facial volumising", "Acne", "Double chin"] },
        ...
        "ThreadLift": { title: "Thread lift", image: ThreadLiftIcon, link: "https://www.carismaaesthetics.com/threadliftmalta", description: "Thread lifts are a non-surgical alternative to a facelift. They involve inserting dissolvable threads into the skin to lift and tighten the skin. They are used to treat wrinkles and facial volume loss.", concerns: ["Wrinkles", "Facial volumising"] },
        "UnderChinReduction": { title: "Fat Reduction", image: UnderChinReductionIcon, link: "https://www.carismaaesthetics.com/chinfatreductionmalta", description: "Under chin reduction is a treatment that involves injecting a fat dissolving solution into the skin. It is used to treat double chin.", concerns: ["Double chin"] },
        "MFU": { title: "MFU", image: MFUIcon, link: "https://www.carismaaesthetics.com/mfu-ultight", description: "MFU (Micro Focused Ultrasound) is a treatment that uses ultrasound energy to tighten the skin and reduce under chin fat. It is used to treat wrinkles and facial volume loss too.", concerns: ["Wrinkles", "Double chin", "Facial volumising"] },
        "LipFillers": { title: "Lip Fillers", image: LipFillersIcon, link: "https://www.carismaaesthetics.com/lipfillers", description: "Lipfillers are a cosmetic procedure where an injection is used to make lips appear fuller.", concerns: ["Thin lips"] }
